  ...
  const addtemplateForm = useFormik({
    ...
    onSubmit: async (values, action) => {
      ...
      if (res.status === 200) {
        ...
        // router.push("/seller/managetemplate");
      } else {
          ...
          >
            ...
            <div className="grid grid-cols-1 space-y-2">
              ...
              <input
                className="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 bg-white"
                type=""
                placeholder="Tell viewers about your Template"
              />
            </div>
            <div className="grid grid-cols-1 space-y-2">
              <label className="text-sm font-bold text-gray-500 tracking-wide">
              ...
              <select
                name=""
                id=""
                className="text-sm pe-2.5 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 bg-white w-full"
              >
