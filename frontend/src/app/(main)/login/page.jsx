...
<>
  {/* Hero */}
  <div className="relative bg-white from-blue-100 via-transparent dark:from-blue-950 dark:via-transparent">
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      {/* Grid */}
      <div className="grid bg-black items-center md:grid-cols-2 gap-8 lg:gap-12">
        <div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="peer p-4 block w-full border-gray-500 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-white dark:border-gray-700 dark:text-black dark:focus:ring-gray-600
                focus:pt-6
                focus:pb-2
                [&:not(:placeholder-shown)]:pt-6
                [&:not(:placeholder-shown)]:pb-2s
                autofill:pt-6
                autofill:pb-2"
                          placeholder="John"
                        />
                        <label
                          ...
                          className="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent dark:text-black peer-disabled:opacity-50 peer-disabled:pointer-events-none
                  peer-focus:text-xs
